...
export const PROJECTS = [
  {
    ...
    image: project1,
    description:
      "project implements an image classifier using three popular Convolutional Neural Network (CNN) architectures: ResNet-18, AlexNet, and VGG16. The models are pretrained on the ImageNet dataset and can classify images into one of 1,000 ImageNet classes.",
